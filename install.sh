...
#   This setup file is based on space-vim's install.sh.
#   Thanks for space-vim.

app_name='TimVim'
dot_timvim="$HOME/.timvim"
[ -z "$APP_PATH" ] && APP_PATH="$HOME/.TimVim"
[ -z "$REPO_URI" ] && REPO_URI='https://github.com/timlee1128/TimVim.git'
...
generate_dot_timvim(){
    ...
    then
        ...
        (
        cat <<DOTSPACEVIM
" You can enable the existing layers in TimVim and
...
function! UserInit()
  ...
  " let g:timvim_leader = "<\Space>"
  " let g:timvim_localleader = ','
